 ...
 * 
 * @class Seo.MonitoringSuggestionEdit
 * @constructor 
 * @namespace Seo
 * @author w.kowalik 
 * @access public
...
Seo.MonitoringSuggestionEdit = Class.create(Seo.Element.prototype, {
    ...
    */       
    send: function (parameters, form) {
        ...
        $.post(Routing.generate('monitoring_suggestion_save', parameters) , form.serialize(),
            function(data){
    ...
    */     
    load: function () {
        ...
        $.ajax({
            type: 'GET',
            dataType: 'json',
            url: Routing.generate('monitoring_question_suggestions', {
...
$(document).ready(function () {
    ...
    Seo.monitoringSuggestionEdit = new Seo.MonitoringSuggestionEdit();
    Seo.monitoringSuggestionEdit.load();
    Seo.monitoringSuggestionEdit.setListeners();    
