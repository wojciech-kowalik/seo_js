...
/**
 * Seo category list class constructor
 * 
...
Seo.CategoryList = Class.create(Seo.Element.prototype,{
   ...
   setListeners: function () {
        ...
        // go back to tools
        $('#back').click(function () {
            window.location = Routing.generate('seo_tools_category');
        });
        ...
        $('.tool-button-submit-filter-no-text, .tool-button-clear-filter').button({
            ...
            window.location = Routing.generate('seo_tools_category_clear_filter');
        }); 
...
$(document).ready(function () {
    ...
    Seo.categoryList = new Seo.CategoryList();
    Seo.categoryList.setListeners();    
