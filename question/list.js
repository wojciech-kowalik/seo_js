...
Seo.QuestionList = Class.create(Seo.Element.prototype,{
   ...
   setListeners: function () {
        ...
        $('.tool-button-submit-filter-no-text, .tool-button-clear-filter').button({
            ...
            window.location = Routing.generate('seo_tools_question_clear_filter');
        }); 
...
//        $('.book-code').bind('click', function(e) {
//
//            e.preventDefault();
//            e.stopPropagation();
//            
...
//                    click: function (){
//                       
//                       $('h2.no-book-code-info').remove();
//                       self._addQuestionBookCode();
//                    }
//                },
//
//                "send":{
...
//            };
//            
//            Seo.modalBox.generate($(this), false, true, buttons, $('<div id="dialog-code"></div>'));
//        }); 
...
$(document).ready(function () {
    ...
    Seo.questionList = new Seo.QuestionList();
